...
export type { GarageSpace } from "./GarageSpace";
export type { ParkMe } from "./ParkMe";
...
export { GarageSpace__factory } from "./factories/GarageSpace__factory";
export { ParkMe__factory } from "./factories/ParkMe__factory";
